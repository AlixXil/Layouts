...
let path = {
  ...
  src: { //исходники
    ...
    imgToWebp: "./" + sourceFolder + "/img/**/*.+(jpg|png|jpeg)",
...
exports.otf2ttf = otf2ttf
  // подготовка шрифтов
exports.fonts = series(fonts, fontStyle)
const build = series(clean, parallel(html, css, js, imagesToWebp, images, fontsToBuild))
exports.build = build
exports.default = series(clean, build, parallel(browserSync, watchFiles))